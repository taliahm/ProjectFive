...
giftApp.getLcboStoresFour = function (id, togetherResultAgain) {
  giftApp.lcboStorebyIdFour = $.ajax({
    ...
    var lcboStoresFinal = [].concat(_toConsumableArray(togetherResultAgain), _toConsumableArray(lcboStoresFour));
...
giftApp.smoothScrollAlcoholResults = function () {
  console.log('smoothscrollin');
  $('html,body').animate({
    scrollTop: $('.alcoholResults').offset().top }, 'slow');
};

giftApp.smoothScrollSomethingDifferent = function () {
  console.log('smoothscrollin');
  $('html,body').animate({
    scrollTop: $('body').offset().top }, 'slow');
};

giftApp.smoothScrollBuyNow = function () {
  console.log('smoothscrollin');
  $('html,body').animate({
